module rv32i_cpu #(
    ...
    // Forward declarations — used before their assign/definition below
    wire        mem_stall;
    wire        mul_div_stall;
    ...
    assign mem_stall  = (exmem_mem_read || exmem_mem_write) && exmem_valid && !dmem_ready;
    ...
    assign mul_div_stall = mul_stall || div_stall;
    ...
    assign take_irq   = (irq_meip || irq_mtip || irq_msip) && idex_valid
                      && !ex_trap && !mem_stall && !mul_div_stall;
    assign irq_cause = irq_meip ? 32'h8000_000B :
